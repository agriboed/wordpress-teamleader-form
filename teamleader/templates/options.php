<div id="teamleader" class="teamleader">
    <form method="post" action="options.php">
                ...
                <div class="installation">
                    ...
                    <div class="step">
                        ...
                        <div class="webhook-field">
                            ...
                            <input value="<?php echo $data['webhook']; ?>" placeholder=""
        ...
        <?php if (null !== $data['webhook']): ?>
            ...
            <button class="button button-primary create-form"><?php _e('Create new form', $data['key']); ?></button>
        <?php endif; ?>
    </form>
            ...
            <div class="body">
                <div class="step">
                    <label>
                        ...
                        <input name="<?php echo $data['form_name']; ?>[submit]"
            ...
            <div class="body-fields">
                <?php foreach ($data['fields'] as $key => $field): ?>
                    <div class="field <?php echo (isset($data['fields_options'][$key]['public']) || true === $field['required']) ? '' : 'disabled'; ?>">
                        ...
                        <div class="name">
                            <strong><label
                                        for="<?php echo $field['title'] ?>"><?php echo $field['title'] ?></label></strong>
                            <div class="description">
                                <?php echo (true === $field['required'] || isset($data['fields_options'][$key]['required'])) ? __('Field is required',
                                    $data['key']) : ''; ?>
                            </div>
                        </div>
                        <div class="label">
